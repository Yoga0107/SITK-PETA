...
if (isset($_GET['page'])) {
	...
	switch ($_GET['page']) {
		...
		case 'hapus-obat':
			...
			break;
		case 'ruang':
			require_once 'app/rumah-sakit/views/index.php';
			break;
		case 'tambah-ruang':
			require_once 'app/rumah-sakit/views/create.php';
			break;
		case 'edit-ruang':
			require_once 'app/rumah-sakit/views/edit.php';
			break;
		case 'hapus-ruang':
			require_once 'app/rumah-sakit/proses/delete.php';
			break;
		case 'rekam-medis':
