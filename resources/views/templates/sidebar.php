  ...
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto"><a class="navbar-brand" href="html/ltr/vertical-menu-template-semi-dark/index.html">
          ...
          <h2 class="brand-text mb-0">SITK-PETA</h2>
        </a></li>
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="<?php echo is_active('dokter'); ?> nav-item">
        <a href="?page=dokter">
          <i class="feather icon-user"></i><span class="menu-title" data-i18n="Dokter">Petugas</span>
        </a>
      </li>
      ...
      <li class="<?php echo is_active('ruang'); ?> nav-item"><a href="?page=ruang"><i class="feather icon-check-square"></i><span class="menu-title" data-i18n="Ruang">Rumah Sakit</span></a>
      </li>
